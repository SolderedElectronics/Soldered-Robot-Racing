...
/**
  ...
  *
  * Original code: https://github.com/BornaBiro/STM32L496_USB_Host_Game_Ctrl
  * Code is modified to work both with a PS2 USB Controller as well as USB Steering Wheel.
  *
  ******************************************************************************
  */
